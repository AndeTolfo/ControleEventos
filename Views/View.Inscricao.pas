...
begin
  ...
  DM.QueryFinanceiro.ParamByName('COD_COND').AsInteger := 1;
  ...
  DM.QueryFinanceiro.ParamByName('TIPOFAVORECIDO').AsString := 'PAR';
...
// Obter o código da conta inserida
  ...
  DM.QueryInscricoes.SQL.Add('INSERT INTO inscricoes (Cod_Evento,Cod_Participante, Tipo_Pagamento, COD_CONTA) VALUES (:CodEvento,:CodParticipante, :TipoPagamento, :COD_CONTA)');
  ...
  DM.QueryInscricoes.ParamByName('COD_CONTA').AsInteger := CodConta;
