...
type
  TfrmPrincipal = class(TForm)
    ...
    procedure ControlePresenas1Click(Sender: TObject);
  private
...
procedure TfrmPrincipal.ControlePresenas1Click(Sender: TObject);
begin
  frmControlePresencas := TfrmControlePresencas.Create(self);
    try
    frmControlePresencas.ShowModal;
    finally
      frmControlePresencas.Free;
    end;
end;
